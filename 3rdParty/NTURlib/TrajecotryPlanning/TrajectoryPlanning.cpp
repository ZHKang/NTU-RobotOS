...
//212
Eigen::MatrixXd TrajectoryPlanning::Splines212( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd qf,  Eigen::VectorXd qfd,  Eigen::MatrixXd qm, double t_total, int select)
{
	//input : 
	//	initial position : q0
	...
	// x = [ a1_0; ~ a1_2; b1_0; ~ b1_1; c1_0; ~ c1_2; 
	//       a2_0; ~ a2_2; b2_0; ~ b2_1; c2_0; ~ c2_2; ... 
	//       a_num434Splines_0; ~ a_num434Splines_2; b_num434Splines_0; ~ b_num434Splines_1; c_num434Splines_0; ~ c_num434Splines_2]
	...
	//for (int i=0;i < N*3*num212Splines;i++){
	//	position(i+1,0) = position(i,0) + t;
	//	velocity(i+1,0) = position(i,0) + t;
	//	acceleration(i+1,0) = position(i,0) + t;
	//}
...
Eigen::MatrixXd TrajectoryPlanning::Splines212( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd qf,  Eigen::VectorXd qfd, double t_total, int select)
{
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
...
//434
Eigen::MatrixXd TrajectoryPlanning::Splines434( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd q0dd,  Eigen::VectorXd qf,  Eigen::VectorXd qfd,  Eigen::VectorXd qfdd,  Eigen::MatrixXd qm, double t_total, int select)
{
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
	...
	//
	//output : 
	//	select :  position : 1   velocity : 2  acceleration : 3  jerk : 4
	//
	...
	// x = [ a1_0; ~ a1_4; b1_0; ~ b1_3; c1_0; ~ c1_4; 
	//       a2_0; ~ a2_4; b2_0; ~ b2_3; c2_0; ~ c2_4; ... 
	//       a_num434Splines_0; ~ a_num434Splines_4; b_num434Splines_0; ~ b_num434Splines_3; c_num434Splines_0; ~ c_num434Splines_4]
	...
	//for (int i=0;i < N*3*num434Splines;i++){
	//	position(i+1,0) = position(i,0) + t;
	//	velocity(i+1,0) = position(i,0) + t;
	//	acceleration(i+1,0) = position(i,0) + t;
	//	jerk(i+1,0) = position(i,0) + t;
	//}
...
Eigen::MatrixXd TrajectoryPlanning::Splines434( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd q0dd,  Eigen::VectorXd qf,  Eigen::VectorXd qfd,  Eigen::VectorXd qfdd, double t_total, int select)
{
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
...
Eigen::MatrixXd TrajectoryPlanning::Splines535( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd q0dd,  Eigen::VectorXd q0ddd,  Eigen::VectorXd qf,  Eigen::VectorXd qfd,  Eigen::VectorXd qfdd,  Eigen::VectorXd qfddd,  Eigen::MatrixXd qm, double t_total, int select)
{
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
	...
	// x = [ a1_0; ~ a1_5; b1_0; ~ b1_3; c1_0; ~ c1_5; 
	//       a2_0; ~ a2_5; b2_0; ~ b2_3; c2_0; ~ c2_5; ... 
	//       a_num535Splines_0; ~ a_num535Splines_5; b_num535Splines_0; ~ b_num535Splines_3; c_num535Splines_0; ~ c_num535Splines_5]
	...
	//for (int i=0;i < N*3*num535Splines;i++){
	//	position(i+1,0) = position(i,0) + t;
	//	velocity(i+1,0) = position(i,0) + t;
	//	acceleration(i+1,0) = position(i,0) + t;
	//	jerk(i+1,0) = position(i,0) + t;
...
Eigen::MatrixXd TrajectoryPlanning::Splines535( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd q0dd,  Eigen::VectorXd q0ddd,  Eigen::VectorXd qf,  Eigen::VectorXd qfd,  Eigen::VectorXd qfdd,  Eigen::VectorXd qfddd, double t_total, int select)
{
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
...
Eigen::MatrixXd TrajectoryPlanning::CubicPolynomials( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd qf,  Eigen::VectorXd qfd,  Eigen::MatrixXd qm, double t_total, int select)
{
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
	...
	//for (int i=0;i < N*numCubicPolynomials;i++){
	//	position(i+1,0) = position(i,0) + t;
	//	velocity(i+1,0) = position(i,0) + t;
	//	acceleration(i+1,0) = position(i,0) + t;
	//	jerk(i+1,0) = position(i,0) + t;
	...
	//for (int i=0; i <= N*numCubicPolynomials ;i++)
	//fp << acceleration.row(i) << endl;//寫入字串
	//cout << "ok" <<endl;
	//fp.close();//關閉檔案
}

Eigen::MatrixXd TrajectoryPlanning::CubicPolynomials( Eigen::VectorXd q0,  Eigen::VectorXd q0d,  Eigen::VectorXd qf,  Eigen::VectorXd qfd, double t_total, int select)
{	
	//input : 
	//	initial position : q0
	//	initial velocity : q0d
