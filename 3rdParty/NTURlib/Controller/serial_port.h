...
public:
	...
	//  FAULHABER Open, Read, Write......
	void FAULHABER_Initial(char* COMport, int m_baudrate);
	//24個value
	void FAULHABER_Write_and_Read(int command[], int encoder[]);
	//command為幾個軸加時間,以及幾個軸encoder
	void FAULHABER_WriteCommand(float Comm[], int type);
};
